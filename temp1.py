...
This is the list of cars 
 ['Honda', 'Hyundai', 'Maruti Suzuki', 'Mahendra']
['Honda', 'Hyundai', 'Maruti Suzuki', 'Mahendra', 'Volkswagon']
Honda
['Honda', 'Hyundai', 'Maruti Suzuki', 'Mahendra']
['Hyundai', 'Maruti Suzuki']
The index of e: 1
The index of i: 2
{1, 3, 37, 43} {90, 34, 67, 77}
False
True
False
False
...
()
('python', 'anaconda')
('python', 'anaconda', 0, 1, 2, 3)
(('python', 'anaconda'), (0, 1, 2, 3), ('btech', 'HM', 'law', 'design'))
('python', 'python', 'python', 'python')
(0, 12, 43, 54, 756, 'hello', 'wolrd')
(12, 43, 54, 756, 'hello', 'wolrd')
(0, 12, 43, 54)
(0, 12, 43, 54, 756, 'hello')
2
7
10
7
...
1
{1: 'BAS', 2: 'ASD', 3: 'ABG'}
dict_items([(1, 'BAS'), (2, 'ASD'), (3, 'ABG')])
3
False
True
{1: 'BAS', 2: 'ASD', 3: {'A': 'Welcome', 'B': 'to', 'C': 'Nested Dict'}}
{1: 'BAS', 2: 'Hey', 3: 5, 0: 'Nj'}
Name here
First
!First
{5: 'Welcome', 7: 'Deletion', 'A': {1: 'One', 2: 'Two', 3: 'Three'}, 'B': {1: 'AOne', 2: 'BTwo'}}
{5: 'Welcome', 7: 'Deletion', 'A': {1: 'One', 3: 'Three'}, 'B': {1: 'AOne', 2: 'BTwo'}}
{7: 'Deletion', 'A': {1: 'One', 3: 'Three'}, 'B': {1: 'AOne', 2: 'BTwo'}}
{7: 'Deletion', 'A': {1: 'One', 3: 'Three'}}
{}
{'A': 18, 'C': 12, 'T': 22, 'R': 25, 'S': 9}
